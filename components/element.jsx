...
const Element = () => {
  return (
    <div className="bg-white dark:bg-[#09090B] min-h-screen px-0 py-12">
      {/* First Section */}
      <div className="w-full bg-fuchsia-50 dark:bg-[#09090B] p-6 flex flex-col md:flex-row items-center pt-5 pb-10 pl-10">
        <div className="md:w-1/2 text-center md:text-left pt-10 pb-10">
          <h3 className="text-blue-600 dark:text-blue-400 font-semibold text-lg mb-2">
            Fast-track your learning
          </h3>
          <h2 className="text-gray-800 dark:text-white font-bold text-5xl mb-4">
            Learn By Doing
          </h2>
          <p className="text-gray-600 dark:text-gray-300">
            Learn programming skills, from absolute beginner to advanced
            mastery. We create project-based courses to help you learn
            professionally and feel like a complete developer.
          </p>
        </div>
      ...
      {/* Second Section */}
      <div className="w-full bg-blue-50 dark:bg-[#09090B] p-6 flex flex-col md:flex-row items-center pt-5 pb-10 pl-10">
        <div className="md:w-1/2 flex justify-center mb-6 md:mb-0">
          <Image
            src="/assets/images/one.png"
            alt="Put Your Learning"
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h3 className="text-green-600 dark:text-green-400 font-semibold text-lg mb-2">
            Step-by-step lessons
          </h3>
          <h2 className="text-gray-800 dark:text-white font-bold text-5xl mb-4">
            Put Your Learning <br /> Into Practice
